...
export default function RastrasLowboysRenta() {

  const harrow = [
    {
      title: "Rastras",
      desc:
        "Equipo agrícola diseñado para nivelar, descompactar y preparar el terreno, garantizando una labranza uniforme y eficiente.",
      images: ["/images/rastras1.jpg", "/images/rastras2.jpg", "/images/rastras3.jpg", "/images/rastras4.jpg", "/images/rastras5.jpg"],
    },
        {
      title: "Lowboys",
      desc:
        "Plataformas de cama baja ideales para transportar maquinaria pesada y equipos de gran tamaño con máxima estabilidad y seguridad.",
      images: ["/images/lowboys1.jpg", "/images/lowboys2.jpg", "/images/lowboys3.jpg", "/images/lowboys4.jpg", "/images/lowboys5.jpg"],
    },
  ...
  const selected = harrow[selectedIndex];
