...
export default function GruasRenta() {
  ...
  const selected = cranes[selectedIndex];
    ...
    <div className="w-full pt-16 pb-24 font-[Oswald]">
      ...
      <div className="w-full flex justify-center">
        <div className="inline-block text-center">
          <h1 className="text-5xl font-extrabold tracking-wide">GRÚAS EN RENTA</h1>
      ...
      <div className="max-w-7xl mx-auto mt-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-4">
        ...
        <div className="relative shadow-2xl">
          <div className="w-full h-[330px] flex items-center bg-[#1f1f1f]">
            <img
